...
export default function Board(props: BoardProps) {
  ...
  return (
    <div className=" flex justify-center  pt-[5rem] ">
      <div className="fixed bottom-0 left-0 right-0 top-0 bg-yellow-400 -z-50 border-b-0 border-[10px] border-black" />
      <div className="fixed bottom-0 left-0 right-0 top-0 -z-50 bg-black/5" />
